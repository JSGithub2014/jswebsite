...
function WhyUs() {
  return (
    <main className='flex flex-col md:flex-row items-center min-h-[50vh] px-4 md:px-24 w-full'>
      ...
      <div className='flex flex-col md:flex-row w-full justify-between items-center md:gap-32'>
        <div className='whyus-img md:w-1/2 mb-4 md:mb-0 md:scale-110'>
          <img
            src={whyUsImage}
        ...
        <div className='whyus-text w-full md:w-1/2 mt-4 md:mt-0'>
          <div className='flex flex-col space-y-4 p-4'>
            <h1 className='text-3xl md:text-5xl font-thin heading-font tracking-wider'>
            ...
            <div>
              <a
                ...
                href="#learn-more" // Updated for better linking
              >
