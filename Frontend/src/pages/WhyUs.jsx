      ...
      <div className='flex flex-col md:flex-row w-full justify-between items-center md:gap-32'> {/* Use gap only for medium screens and larger */}
        ...
        <div className='whyus-text w-full md:w-1/2 mt-4 md:mt-0'>
          <div className='flex flex-col space-y-4 p-4'>
            <h1 className='text-3xl md:text-5xl font-thin heading-font tracking-wider '>  <span className=' tracking-wider heading-font '>W</span>hy  <span className=' text-[rgb(255,102,0)]'>Us</span>?</h1> {/* Larger text for larger screens */}
