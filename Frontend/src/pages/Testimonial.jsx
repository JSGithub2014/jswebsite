...
function Testimonial() {
  return (
    <div className="flex flex-col md:flex-row justify-between px-[5vw] items-center h-screen py-10 bg-[#fc7b0386]">
      <div className="md:w-1/2 px-6">
      <RiDoubleQuotesL className='text-8xl text-zinc-500 mb-[2vw]'/>
        <h1 className="text-6xl font-semibold mb-4 text-black ">What Our <br /> Client Say?</h1>
