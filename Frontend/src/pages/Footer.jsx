...
function Footer() {
  return (
    <>
      {/* Large Screen Footer */}
      <footer className="w-full text-white pt-2 pb-2 relative bg-[rgb(255,102,0)] z-0 hidden md:block">
        ...
        <div className="container mx-auto mt-2">
          <hr className="border-t border-zinc-500 opacity-90" />
        </div>
      ...
      <footer className="w-full text-white pt-4 pb-4 bg-[rgb(255,102,0)] z-0 md:hidden">
  ...
  {/* Contact Information Inside Address Box */}
  <div className="mt-4 flex items-center justify-between space-x-6 text-white">
    <div className="flex items-center space-x-2">
      <FaPhoneAlt className="text-lg text-[rgb(59,58,58)]" />
      <a href="tel:+918012091209" className="text-xs hover:text-black transition-colors duration-300">
        +91 8012091209
      </a>
    </div>

    <div className="flex items-center space-x-2">
      <FaEnvelope className="text-lg text-[rgb(59,58,58)]" />
      <a href="mailto:info@jsasia.net" className="text-xs hover:text-black transition-colors duration-300">
        info@jsasia.net
      </a>
    </div>
  </div>
    ...
    {/* Support and Links Sections (side by side) */}
    <div className="flex justify-between gap-6 mb-6">

      {/* Support Section */}
      <div className="w-1/2 text-center md:text-left space-y-3">
        <h3 className="font-bold text-sm mb-2 text-gray-200">Support</h3>
        <ul className="space-y-2 text-xs text-gray-300">
          {["FAQs", "Help Center", "Contact Support"].map((item) => (
            <li key={item} className="transition-transform transform hover:translate-x-2">
              <a
                href={`#${item.toLowerCase().replace(/\s/g, '')}`}
      ...
      {/* Links Section */}
      <div className="w-1/2 text-center md:text-left space-y-3">
        <h3 className="font-bold text-sm mb-2 text-gray-200">Links</h3>
        <ul className="space-y-2 text-xs text-gray-300">
          {["Privacy Policy", "Terms & Conditions"].map((item) => (
            <li key={item} className="transition-transform transform hover:translate-x-2">
              <a
