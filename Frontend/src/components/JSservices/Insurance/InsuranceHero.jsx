  ...
  return (
    ...
    >
      ...
      <div className='w-full md:w-5/6 h-auto'>
        <img src={ServiceHeroImg} alt="Insurance Services" className='w-full h-auto object-cover my-5 rounded-lg ' />
      ...
      <div className='w-full md:w-5/6 mt-10 text-center'>
        <h2 className='text-3xl heading-font font-semibold tracking-wider text-[rgb(255,102,0)] mb-4'>Why Choose Us for Your <span className='heading-font font-semibold tracking-wider text-black'>Insurance Needs?</span></h2>
