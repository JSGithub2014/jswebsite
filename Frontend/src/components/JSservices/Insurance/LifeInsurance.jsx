...
const LifeInsurance = () => {
  ...
  return (
    ...
    >
      <h2 id="life-insurance-title" className="text-3xl md:text-4xl heading-font font-semibold tracking-wider text-[rgb(255,102,0)] mb-6">
      ...
      <div className="w-5/6 flex flex-col items-start">
        ...
        <h3 className="text-xl md:text-2xl font-semibold text-[rgb(255,102,0)] mb-4 text-center w-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6 max-w-4xl">
            {[
              ...
              >
                ...
                <h4 id={`coverage-${index}`} className="text-base md:text-lg font-semibold">{item.title}</h4>
              </motion.article>
            ))}
          </div>
        </div>

        <h3 className="text-xl md:text-2xl font-semibold text-[rgb(255,102,0)] mb-4">Why Choose Our Life Insurance?</h3>
