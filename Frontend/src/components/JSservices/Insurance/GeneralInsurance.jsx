...
const GeneralInsurance = () => {
  ...
  return (
    ...
    >
      <h2 className="text-4xl heading-font font-semibold tracking-wider text-[rgb(255,102,0)] mb-6">Comprehensive General  <span className='heading-font font-semibold tracking-wider text-black'>Insurance Solutions</span></h2>
      ...
      <div className="w-5/6 flex flex-col items-start">
        ...
        <h3 className="text-2xl font-semibold text-[rgb(255,102,0)] mb-4 text-center w-full">👇 Our General Insurance Coverage Includes 👇 </h3>
        
        <div className="w-full flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 max-w-4xl">
            {[
        ...
        <h3 className="text-2xl font-semibold text-[rgb(255,102,0)] mb-4">Why Choose Our General Insurance?</h3>
        ...
        <div className="mt-4 flex flex-col md:flex-row items-center justify-center">
          <a href="tel:+912245120755" className="px-6 py-2 bg-[rgb(255,102,0)] text-white rounded-full hover:bg-orange-600 transition duration-300 mb-2 md:mb-0 md:mr-4">
            Call Now: +91 2245120755
          </a>
          <a href="/contact" className="px-6 py-2 bg-gray-400 text-white rounded-full hover:bg-gray-500 transition duration-300">
            Contact Us
          </a>
        </div>
      </div>
