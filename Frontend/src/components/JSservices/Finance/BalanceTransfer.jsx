  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <header className="text-center py-10">
        ...
        <p className="text-sm md:text-lg text-gray-700">Transfer your balance with ease and save on interest.</p>
      </header>

      <section className="mt-8">
        <h2 className="text-lg md:text-2xl font-semibold mb-4 text-gray-800">✨ Why Choose Our Balance Transfer?</h2>
