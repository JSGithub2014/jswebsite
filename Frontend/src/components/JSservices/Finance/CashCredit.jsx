  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <header className="text-center py-10">
        ...
        <p className="text-sm md:text-lg text-gray-700">Access flexible funding solutions tailored for your business needs.</p>
      </header>

      <section className="mt-8">
        <h2 className="text-lg md:text-2xl font-semibold mb-4 text-gray-800">✨ Why Choose Our Cash Credit?</h2>
