  ...
  return (
    <main className="max-w-7xl mx-auto p-6">
      <header className="text-center py-10">
        ...
        <p className="text-sm md:text-lg text-gray-700">Secure your future with our flexible mortgage loan options.</p>
      </header>

      <section className="mt-8">
        <h2 className="text-lg md:text-2xl font-semibold mb-4 text-gray-800" role="heading" aria-level="2">✨ Why Choose Our Mortgage Loans?</h2>
