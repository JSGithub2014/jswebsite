  ...
  return (
    <div className='flex flex-col md:flex-row justify-center p-4 mt-20'>
      ...
      <div className="block md:hidden w-full mb-6">
        ...
        <p className="text-md text-gray-600 text-justify pr-8">
      ...
      {/* Team members cards on the left for large screens */}
      <div className='flex flex-wrap justify-center w-full md:w-2/3 mb-6 gap-5'>
        {teamMembers.map((member, index) => (
          <div key={index} className='flex flex-col items-center w-full sm:w-1/3 md:w-1/2 lg:w-auto mb-6'>
            <div 
              className='w-[180px] h-[180px] bg-[rgba(255,102,0,0.8)] rounded-lg shadow-lg cursor-pointer transform transition-transform duration-300 hover:scale-105 flex justify-center items-center'
      ...
      {/* Introductory text on the right for large screens */}
