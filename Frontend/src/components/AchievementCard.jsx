...
function AchievementCard({ imgSrc, title, description, achievementNumber }) {
  return (
    <article 
      className="bg-white shadow-lg rounded-lg p-8 m-2 flex flex-col" 
      role="article" 
    ...
    >
      ...
      {/* Achievement number */}
      <p 
        className="text-base md:text-2xl font-extrabold text-left mt-2" 
      ...
      {/* Title */}
      <h2 
        className="text-sm md:text-md font-medium text-left mt-1" 
      ...
      {/* Description */}
      <p 
        className="text-gray-600 text-xs md:text-sm text-left mt-1 text-justify" 
