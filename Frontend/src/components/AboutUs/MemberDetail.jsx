...
const MemberDetail = () => {
  ...
  return (
    <motion.section
      className="min-h-screen flex flex-col items-center justify-evenly p-4 md:pt-20"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      {/* Back Button */}
      <motion.button
        className="flex items-center mb-6 text-[rgb(255,102,0)] bg-white border border-[rgb(255,102,0)] rounded-lg px-4 py-2 transition-colors duration-200 ease-in-out transform hover:bg-[rgb(255,102,0)] hover:text-white hover:shadow-xl"
      ...
      >
        {/* Needle (Pin) */}
        <div
          className="absolute top-[-7px] left-1/2 transform -translate-x-1/2 z-10 "
          style={{
        ...
        <div className="flex flex-col justify-center md:w-1/2 md:ml-4">
          ...
          <p className="text-gray-800 text-sm md:text-lg mt-2 text-justify">
